...
//extern UBYTE* MEMORY_mem;           // dynamically allocate memory to limit size of statics
extern UBYTE* under_atarixl_os;     // grr 16k
extern const UBYTE* MEMORY_os;      // in rom on esp32

#define TIGHT_MEM
#ifdef TIGHT_MEM
extern const UBYTE* MEMORY_basic;
#else
